...
export const productHelpDocs = {
  brief: {
    ...
    title: 'AI 小说转剧本工具',
    description:
      'AI小说转剧本工具是一款面向小说作者、编剧和内容创作者的辅助创作工具。系统可以将三个章节以上的小说文本自动解析，并转换为结构化的 YAML 剧本初稿。本工具生成的剧本不是最终成稿，而是可编辑、可修改、可继续打磨的剧本初稿。',
  },
  intro: [
  ...
  requirements: [
    '支持导入或粘贴 3 个章节以上的小说文本。',
    '自动识别章节结构，并判断章节数量是否不少于 3 章。',
  ...
  workflow: [
    ...
    { step: '02', title: '章节自动识别', detail: '系统会自动识别小说中的章节结构，并判断章节数量是否不少于 3 章。' },
  ...
  faq: [
    { question: '为什么必须导入三个章节以上？', answer: '题目要求工具能够处理三个章节以上的小说文本，因此系统需要对章节数量进行校验。章节数量不足时，可能无法体现完整的人物、场景和剧情结构。' },
    ...
    { question: '可以导出哪些格式？', answer: '系统支持导出 YAML、TXT、Markdown 和 PDF 格式。其中 YAML 适合后续程序读取和编辑，TXT、Markdown、PDF 适合阅读和提交。' },
